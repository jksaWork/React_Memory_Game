...
function Winner() {
  const { gameOver, restartTheGame } = useGameContext();
  return (
    <div
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-row justify-around mt-10">
          <span
            ...
            className="px-3 py-2 shadow-md font-bold rounded-md bg-gradient-to-r from-[#f24699] to-primary"
          >
            {" "}
            Play More
          </span>
          <span className="px-3 py-2 shadow-md font-bold"> quite</span>
        </div>
      </div>
    </div>
  );
