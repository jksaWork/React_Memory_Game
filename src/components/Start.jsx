...
function Start() {
  const { HandelUserName, setBoardScreen } = useGameContext();
  return (
    <div className="w-full  relative h-screen overflow-hidden   bg-primary flex justify-center items-center">
      <FaltingImage />

      <div className="p-3  z-[3]  bg-primary drop-shadow- shadow-xl flex flex-col gap-3 px-3 ">
        ...
        <div className="text-center">
          <button
            ...
            className="w-full bg-opacity-75  bg-[#f24699] text-white rounded-lg font-bold mx-3 p-2"
          >
            Paly Now
          </button>
        </div>
